...
begin
    ...
    begin
        insert into Enterprise(organization_id, goz_attribute_id, project_id, year_number, expenditures_id,
                               enterprise_value)
        values (3, 1, 1083, 21, 1, 0.0),
               (3, 1, 1083, 21, 2, 0.0),
               (3, 1, 1083, 21, 3, 1471494690.0),
               ...
               (3, 1, 1083, 21, 40, 0.0),
               (3, 1, 1083, 21, 41, 59825866.2),
               (3, 1, 1083, 21, 42, 0.0),
               (3, 1, 1083, 21, 43, 1413424.4),
               ...
               (3, 1, 1083, 22, 60, 271.0),
               (3, 1, 1083, 22, 61, 930253892.14),
               (3, 1, 1083, 22, 62, 46574400.33),
               (3, 1, 1083, 22, 63, 27460927.9),
               (3, 1, 1083, 23, 1, 0.0),
               (3, 1, 1083, 23, 2, 0.0),
               (3, 1, 1083, 23, 3, 3161791350.0),
               (3, 1, 1083, 23, 4, 213024073.7),
               (3, 1, 1083, 23, 5, 131832716.11),
               (3, 1, 1083, 23, 6, 0.0),
               (3, 1, 1083, 23, 7, 0.0),
               (3, 1, 1083, 23, 8, 2379767567.85),
               (3, 1, 1083, 23, 9, 4058562398.0),
               ...
               (3, 1, 1083, 23, 59, 4058562398.0),
               (3, 1, 1083, 23, 60, 379.0),
               (3, 1, 1083, 23, 61, 1302355450.0),
               (3, 1, 1083, 23, 62, 65204000.0),
               (3, 1, 1083, 23, 63, 38445297.93),
               (3, 1, 1083, 24, 1, 0.0),
               (3, 1, 1083, 24, 2, 0.0),
               (3, 1, 1083, 24, 3, 3477970000.0),
               ...
               (3, 1, 1083, 24, 27, 691752444.0),
               (3, 1, 1083, 24, 28, 0.0),
               (3, 1, 1083, 24, 29, 62027823.0),
               (3, 1, 1083, 24, 30, 103817176.0),
               (3, 1, 1083, 24, 31, 25449168.0),
               (3, 1, 1083, 24, 32, 9266792.0),
               (3, 1, 1083, 24, 33, 71661621.0),
               (3, 1, 1083, 24, 34, 1521778.0),
               (3, 1, 1083, 24, 35, 167913.0),
               (3, 1, 1083, 24, 36, 17130.0),
               (3, 1, 1083, 24, 37, 0.0),
               (3, 1, 1083, 24, 38, 12386.0),
               (3, 1, 1083, 24, 39, 10369601.0),
               (3, 1, 1083, 24, 40, 0.0),
               (3, 1, 1083, 24, 41, 166643034.0),
               (3, 1, 1083, 24, 42, 98683.0),
               (3, 1, 1083, 24, 43, 469339.0),
               (3, 1, 1083, 24, 44, 24798032.0),
               (3, 1, 1083, 24, 45, 22533196.0),
               (3, 1, 1083, 24, 46, 46422916.0),
               (3, 1, 1083, 24, 47, 96345.0),
               (3, 1, 1083, 24, 48, 49200305.0),
               (3, 1, 1083, 24, 49, 4268259.0),
               (3, 1, 1083, 24, 50, 0.0),
               (3, 1, 1083, 24, 51, 43754158.0),
               (3, 1, 1083, 24, 52, 1502354.0),
               (3, 1, 1083, 24, 53, 47654435.0),
               ...
               (3, 1, 1083, 24, 60, 417.0),
               (3, 1, 1083, 24, 61, 1432591000.0),
               (3, 1, 1083, 24, 62, 71724000.0),
